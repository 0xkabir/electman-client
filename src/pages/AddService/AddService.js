...
const AddService = () => {
    ...
    const handleAddService = event => {
        ...
        const imgurl = form.thumbimgurl.value;
        const fullimg = form.fullimgurl.value;
        const price = form.price.value;
        const intro = form.intro.value;
        const description = form.description.value;
        const servcieObj = {name, imgurl, fullimg, price, intro, description}
    ...
    return (
        <div className='text-center'>
            ...
            <form onSubmit={handleAddService}>
                ...
                <input type="text" name="thumbimgurl" placeholder='Thumbnail Image URL' className='block w-11/12 md:w-3/4 lg:w-1/2 mx-auto px-2.5 py-1 border-2 border-gray-400 my-2.5 rounded focus:border-orange-600 ' required/>
                <input type="text" name="fullimgurl" placeholder='Full Size Image URL' className='block w-11/12 md:w-3/4 lg:w-1/2 mx-auto px-2.5 py-1 border-2 border-gray-400 my-2.5 rounded focus:border-orange-600 ' required/>
